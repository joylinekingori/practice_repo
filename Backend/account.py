...
class BankAccount:       remove self.deposits and withdrawasl put in transactionsexit()[]
    ...
    def calculate_interest(self):
        ...
        self.transactions.append(f"Interest Applied: +${interest:.2f}")
...
account1 = BankAccount("12345", "Lwam Bisrat", 1000)
account2 = BankAccount("67890", "Bereket Mehari", 500)
...
print(account1.change_account_owner("Lwam Berhe"))
...
print(account1.set_minimum_balance(100))
print(account1.withdraw(1050))
print(account1.close_account())
print(account1)

class transaction:
    amount,naration,time,transaction_time,date and time
    def 